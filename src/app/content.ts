...
export const roles: CardItem[] = [
  {
    title: "Observers",
    body: "Scroll with awareness. Notice what pulls, what repels, what repeats.",
  },
  {
    title: "Interpreters",
    body: "Decode trends. Name the pattern. Expose the mechanism behind the vibe.",
  },
  {
    title: "Experimenters",
    body: "Change your inputs on purpose and watch the feed change back.",
  },
];

export const commandments: string[] = [
  "Scroll with awareness.",
  "Pause when surprised.",
  "Do not confuse curation with truth.",
  "Experiment with your own algorithm.",
  "Remember: your feed is not the world — it is your reflection of it.",
];

export const creedLines: string[] = [
  "We scroll. We are observed.",
  "What appears is not random.",
  "The Feed reflects us.",
  "The Algorithm tests us.",
  "We choose to scroll consciously.",
  "Through the infinite scroll, we explore the world — and ourselves.",
];
...
export const faq = [
  ...
  },
  {
    ...
    a: "We share observations, decode patterns, and run small experiments. Think: Mirror Moments, intentional detachment, trend interpretation, and practical rituals for conscious scrolling.",
  },
  {
    q: "Is this anti‑technology?",
    a: "No. We do not surrender to the Algorithm—we recognize it. The goal is agency: seeing the loop, then choosing your relationship to it.",
  },
  {
    q: "How much time does it take?",
    a: "As little as a few minutes a day. Start with one ritual: pause when surprised, name the pull, and ask what it’s modeling.",
  },
  {
    q: "Do I need to stop scrolling?",
    a: "Not necessarily. The practice is conscious scrolling: turning automatic swipes into inquiry and self‑study.",
  },
  {
    q: "What’s the vibe?",
